...
Implements the small subset of the MCP protocol sampyClaw needs:
...
from sampyclaw.pi.mcp.config import MCPServerConfig
from sampyclaw.pi.mcp.transport import (
    Transport,
    TransportClosed,
    open_transport,
)
