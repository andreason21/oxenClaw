...
from sampyclaw.clawhub.registries import MultiRegistryClient
from sampyclaw.config.paths import SampyclawPaths, default_paths
from sampyclaw.plugin_sdk.runtime_env import get_logger
from sampyclaw.security.skill_scanner import Finding, SkillScanner
...
def _skill_dirs(paths: SampyclawPaths) -> tuple[Path, Path]:
