...
- Google Generative AI: parts list with `{"inline_data": {"mime_type":
  "...", "data": "<base64>"}}`
- pi (`sampyclaw.pi.messages.ImageContent`): a Pydantic model — return
...
from sampyclaw.multimodal.inbound import InboundImage
...
def pi_image_content(image: InboundImage):  # type: ignore[no-untyped-def]
    ...
    """
    from sampyclaw.pi.messages import ImageContent
