...
sampyclaw ToolRegistry so the agent can call it.
"""
...
class _CreateArgs(BaseModel):
    ...
    homepage: str = Field("https://github.com/sampyclaw")
    emoji: str = Field("✨")
...
def skill_creator_tool(*, paths: SampyclawPaths | None = None) -> Tool:
    ...
    return FunctionTool(
        name="skill_creator",
        description=(
            "Scaffold a new skill into ~/.sampyclaw/skills/<slug>/. "
