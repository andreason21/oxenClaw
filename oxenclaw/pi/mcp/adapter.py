"""Bridge MCP tools into oxenClaw's `ToolRegistry`.
...
oxenClaw tools the agent already has).
"""
...
from oxenclaw.pi.mcp.client import MCPClientPool, MCPError
...
class _MCPProxyTool:
    """Implements the oxenClaw `Tool` Protocol for one MCP tool."""
