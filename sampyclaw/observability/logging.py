...
Activated by setting `SAMPYCLAW_LOG_FORMAT=json` (other values fall back
...
Usage in subsystems::
    ...
    from sampyclaw.observability.logging import correlation_scope
...
def configure_logging(
    *,
    ...
    `fmt` precedence: explicit arg → `SAMPYCLAW_LOG_FORMAT` env →
    "human". Valid values: "json" or "human".
    """
    chosen = (fmt or os.environ.get("SAMPYCLAW_LOG_FORMAT") or "human").lower()
