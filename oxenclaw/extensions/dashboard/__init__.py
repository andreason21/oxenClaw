...
surface without requiring Telegram, Slack, or any other external channel
to be configured. Required in environments where outbound messaging
platforms are blocked (corporate networks, air-gapped installs).
"""
