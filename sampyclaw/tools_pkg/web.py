...
`sampyclaw.security.net` (see `guarded_session`). This module wires the
...
from sampyclaw.pi.registry import AuthStorage
from sampyclaw.plugin_sdk.runtime_env import get_logger
from sampyclaw.security.net import NetPolicy
...
DEFAULT_USER_AGENT = "sampyclaw-web/1.0 (+https://github.com/sampyclaw)"
