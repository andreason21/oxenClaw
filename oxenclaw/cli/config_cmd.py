"""`oxenclaw config` subcommands — show, validate."""
...
from oxenclaw.config import ConfigError, default_paths, load_config

app = typer.Typer(help="Inspect and validate oxenclaw config.yaml.", no_args_is_help=True)
