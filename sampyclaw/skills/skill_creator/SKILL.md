---
name: skill-creator
description: "Scaffold a new SKILL.md (and an optional Python tool stub) into ~/.sampyclaw/skills/<slug>/. Validates frontmatter."
...
2. The tool builds `~/.sampyclaw/skills/<slug>/SKILL.md` with valid
