...
Config file: `~/.oxenclaw/mcp.json` by default. Shape::
...
from oxenclaw.pi.mcp.client import MCPClientPool
from oxenclaw.pi.mcp.config import MCPServerConfig, parse_servers_map
